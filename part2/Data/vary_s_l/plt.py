...
plt.figure()
#plt.errorbar(np_arr[:,0],np_arr[:,7],yerr=np_arr[:,8],ecolor='red')
plt.plot(np_arr[:,0],np_arr[:,1])
plt.plot(np_arr[:,0],np_arr[:,2])
plt.plot(np_arr[:,0],np_arr[:,3])
plt.plot(np_arr[:,0],np_arr[:,4])
plt.plot(np_arr[:,0],np_arr[:,5])
plt.legend(['L = 50','L = 60','L = 70','L = 80','L = 90'])
